          ...
          <div className="lg:col-span-7">
            <Accordion type="single" collapsible>
              <AccordionItem value="results" className="border-none">
                <AccordionTrigger className="w-full bg-primary/5 hover:bg-primary/10 hover:no-underline rounded-lg border border-border/60 shadow-sm px-4 py-3 [&>svg]:text-primary">
